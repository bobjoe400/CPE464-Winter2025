...
def run_concurrent_clients_test(results_dir):
    ...
    client_tests = [
        { "from_file": "random_small_text.txt",
          ...
          "base_client_log": "client_concurrent_small", "test_name": "Concurrent Test: Small File" },
        { "from_file": "random_medium_text.txt",
          "downloaded": "downloaded_medium_concurrent",
          "window": 10, "buffer": 1000, "error": 0.2,
          "base_client_log": "client_concurrent_medium", "test_name": "Concurrent Test: Medium File" },
        { "from_file": "random_big_text.txt",
          "downloaded": "downloaded_bigw50_concurrent",
          "window": 50, "buffer": 1000, "error": 0.1,
          "base_client_log": "client_concurrent_bigw50", "test_name": "Concurrent Test: Big File Window Size 50" },
        { "from_file": "random_big_text.txt",
          "downloaded": "downloaded_bigw5_concurrent",
          "window": 5, "buffer": 1000, "error": 0.15,
          "base_client_log": "client_concurrent_bigw5", "test_name": "Concurrent Test: Big File Window Size 5" },
    ]
